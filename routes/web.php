...
Route::get('/quatation/{id}',[QuatationController::class, 'viewInvoice'])->name('getQuatation');
...
Route::group(['prefix'=>$prefix,'middleware'=>'auth:admin'], function () use($prefix) {
    ...
    Route::resource('quatation', QuatationController::class)->only(['index', 'create', 'edit', 'store', 'destroy'])->names($prefix .'.quatation');
