...
class SaleController extends Controller
{
    ...
    public function index(Request $request){
        if($request->ajax()){
            $data = $this->modelIns()::where('branch',$this->branch())->get();
            ...
            return view('manager.invoice.indexInvoice')
    ...
    public function create(){
        ...
        $branch_dataset = Branch::where('id',$this->branch())->get();
        $invoiceno = '#';
        return view('manager.invoice.editInvoice',compact('category_dataset','customer','branch_dataset'))
    ...
    public function edit($id){
        ...
        return view('manager.branch.editBranch',compact('sales'))
