...
<head>
    @php
    $middle_name = '';
        $userRole = Auth::guard('employee')->user()->department_id;
                    if($userRole == '1'){
                        $middle_name = "manager";
                    }else if($userRole == '2'){
    ...
    <title>:: Black Bull {{ $middle_name }} ::</title>
    <!-- App favicon -->
            ...
            <div class="d-flex">
                ...
                <div class="dropdown d-inline-block user-dropdown">
                    <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img class="rounded-circle header-profile-user" src="//gravatar.com/avatar/{{ Auth::guard('employee')->user()->email }}?s=100" alt="Header Avatar">
                        <span class="d-none d-xl-inline-block ms-1">{{ Auth::guard('employee')->user()->first_name }}</span>
                        <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        {{-- <a class="dropdown-item" href="../master/employee_profile.php?id={{Auth::guard('employee')->user()->id}}"><i class="ri-user-line align-middle me-1"></i> Profile</a> --}}
    ...
    <div class="vertical-menu">
        ...
        <div data-simplebar class="h-100">
            ...
            <div class="user-profile text-center mt-3">
                <div class="">
                    <img src="//gravatar.com/avatar/{{ Auth::guard('employee')->user()->email }}?s=100" alt="" class="avatar-md rounded-circle">
                </div>
                <div class="mt-3">
                    <h4 class="font-size-16 mb-1">{{ Auth::guard('employee')->user()->first_name }}</h4>
            ...
            <div id="sidebar-menu">
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li><a href="{{route($middle_name.'.dashboard')}}"  class="wave-effect"><i class="mdi mdi-desktop-mac-dashboard"></i><span>Dashboard</span></a></li>
                    <li><a href="#"  class="has-arrow wave-effect"><i class="mdi mdi-wallet-plus"></i><span>Purchase</span></a>
                        <ul class="sub-menu mm-collapse" aria-expanded="false">
                            <li><a href="{{route($middle_name.'.purchase.index')}}"><i class="mdi mdi-database-arrow-left"></i>Purchase Order</a></li>
                        </ul>
                    </li>
                    <li><a href="#"  class="has-arrow wave-effect"><i class="mdi mdi-sale"></i><span>Product Sales</span></a>
                        <ul class="sub-menu mm-collapse" aria-expanded="false">
                            <li><a href="{{route($middle_name.'.sales.index')}}"><i class="mdi mdi-database-arrow-right"></i>Sales</a></li>
                        </ul>
                    </li>
                    <li><a href="#"  class="has-arrow wave-effect"><i class="mdi mdi-wallet-bifold"></i><span>Expense</span></a>
                        <ul class="sub-menu mm-collapse" aria-expanded="false">
                            <li><a href="{{route($middle_name.'.expense.index')}}"><i class="mdi mdi-calendar-account-outline"></i>Month</a></li>
                        </ul>
                    </li>
                    @elseif (Auth::guard('employee')->user()->department_id == "2")
