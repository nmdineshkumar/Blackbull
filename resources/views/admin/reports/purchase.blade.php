                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6 colsm-12 text-end">
                            <a href="{{route('admin.purchase.over-all-sales')}}" target="_blank" class="btn btn-primary"><span>Export to Purchase Report</span></a>
                        </div>
                    </div>
...
@section('add-js')
<script>
    var montly_url = "{{route('admin.purchase.montly-sales',['id:'])}}";
    var datewise_url = "{{route('admin.purchase.datewise-sales',['from:','to:'])}}"
