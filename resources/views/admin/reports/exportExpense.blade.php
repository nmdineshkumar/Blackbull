                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6 colsm-12 text-end">
                            <a href="{{route('admin.expense.over-all-expense')}}" target="_blank" class="btn btn-primary"><span>Export to Expense Report</span></a>
                        </div>
                    </div>
...
@section('add-js')
<script>
    var montly_url = "{{route('admin.expense.montly-expense',['id:'])}}";
    var datewise_url = "{{route('admin.expense.datewise-expense',['from:','to:'])}}"
