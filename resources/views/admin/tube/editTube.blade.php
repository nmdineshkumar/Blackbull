@php
    ...
    if ($id != '') {
        ...
        $visible_status = old('visible_status') != '' ? $visible_status : $tube->status;
    }
    if ($image != '') {
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <a data-bs-toggle="modal" data-bs-target="#volveModal"
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <a data-bs-toggle="modal" data-bs-target="#tubeheightModal"
                                                    class="btn btn-primary"><i class="mdi mdi-plus-circle"></i></a>
                                            </div>
                                        </div>
                                        @error('height')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <a data-bs-toggle="modal" data-bs-target="#tuberimsizeModal"
                                                    class="btn btn-primary"><i class="mdi mdi-plus-circle"></i></a>
                                            </div>
                                        </div>
                                        @error('rim_size')
    ...
    <div class="modal fade" id="tubeheightModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form ajax-submit="true" id="addTubeheight" action="{{ route('save-tube-height') }}"
                        method="post">
                        @csrf
                        <div class="row">
                            <div class="col-12">
    ...
    <div class="modal fade" id="tuberimsizeModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form ajax-submit="true" id="addTuberimsize" action="{{ route('save-tube-rim-size') }}"
                        method="post">
                        @csrf
                        <div class="row">
                            <div class="col-12">
