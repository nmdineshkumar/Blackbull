...
@php
    ...
    if ($id != '') {
        ...
        $invoice = old('invoice') != '' ? $invoice : $branches->invoice;
                    ...
                    <form action="{{ route($resourceUrl . '.store') }}" method="post">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" name="address2" id="address1" class="form-control"
                                    value="{{ $address2 }}">
                                @error('address2')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 col-sm-12">
                                ...
                                <textarea name="comments" id="comments" cols="15" rows="5" class="form-control">{{ $comments }}</textarea>
                            </div>
                            <div class="col-md-6 col-sm-12">
