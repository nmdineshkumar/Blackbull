        ...
        <div class="my-5">
            <div class="row py-5">
                <div class="col-md-6 col-sm-12">
                    <div class="woocommerce-product-gallery woocommerce-product-gallery--with-images woocommerce-product-gallery--columns-4 images"
                        ...
                        <figure class="woocommerce-product-gallery__wrapper">
                            <div data-thumb="{{ asset('storage/products/tyre/' . $product->image) }}" data-thumb-alt=""
                                class="woocommerce-product-gallery__image" style="position: relative; overflow: hidden;"><a
                                    href="{{ asset('storage/products/tyre/' . $product->image) }}"
                                    rel="prettyPhoto[slideshow]" class="inited"><img width="600" height="600"
                                        src="{{ asset('storage/products/tyre/' . $product->image) }}" class="wp-post-image"
                                        alt="" decoding="async" loading="lazy" title="i3" data-caption=""
                                        data-src="{{ asset('storage/products/tyre/' . $product->image) }}"
                                        data-large_image="{{ asset('storage/products/tyre/' . $product->image) }}"
                                        data-large_image_width="1200" data-large_image_height="1200"
                                        srcset="{{ asset('storage/products/tyre/' . $product->image) }}"
                                        sizes="(max-width: 600px) 100vw, 600px"></a><img role="presentation" alt=""
                                    src="{{ asset('storage/products/tyre/' . $product->image) }}" class="zoomImg"
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-3 py-2"><label for="" class="fw-bold">Make</label></div>
                        <div class="col-sm-12 col-md-9  py-2">
                            {{ \App\Http\Controllers\HelperController::get_makerName($product->cars) }}</div>
                        <div class="col-sm-12 col-md-3 py-2"><label for="" class="fw-bold">Model</label></div>
                        <div class="col-sm-12 col-md-9 py-2">
                            {{ \App\Http\Controllers\HelperController::get_modelName($product->cars) }}</div>
                        <div class="col-sm-12 col-md-3 py-2"><label for="" class="fw-bold">Year</label></div>
                        <div class="col-sm-12 col-md-9 py-2">
                            {{ \App\Http\Controllers\HelperController::get_TyreYear($product->cars) }}</div>
                        <div class="col-sm-12 col-md-3 py-2"><label for="" class="fw-bold">Size</label></div>
                        <div class="col-sm-12 col-md-9 py-2">
                            {{ \App\Http\Controllers\HelperController::get_TyreSize($product->cars) }}</div>
                        <div class="col-sm-12 col-md-3 py-2"><label for="" class="fw-bold">Origin</label></div>
                        <div class="col-sm-12 col-md-9 py-2">
                            {{ \App\Http\Controllers\HelperController::get_TyreOrigin($product->cars) }}</div>
                        ...
                        <div class="col-sm-12 col-md-12 py-5">
                            <div class="product_meta">
                                ...
                                <span class="posted_in  d-flex">Categories: <a
                                        href="https://reisen.themerex.net/product-category/tires/" rel="tag" class="ms-3">Tires</a>,
                                    <a href="https://reisen.themerex.net/product-category/wheels/"
                                        rel="tag">Wheels</a></span>
                                <span class="tagged_as  d-flex">Tags: <a
                                        href="https://reisen.themerex.net/product-tag/premium/" rel="tag" class="ms-3">premium</a>,
                                    <a href="https://reisen.themerex.net/product-tag/race/"
                                        rel="tag">race</a></span>
                                <span class="product_id  d-flex">Product ID: <span class="ms-3">188</span></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card rounded-0">
                        <a class="hover_icon hover_icon_link mb-3"
                            href="{{ route('frontend.tyre.product-detail', base64_encode($row->id)) }}"><img class="card-img-top"
                                alt="Multiple Options" src="{{ asset('storage/products/tyre/' . $row->image) }}"></a>
