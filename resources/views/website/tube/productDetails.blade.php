            ...
            <div class="row py-5">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-9 py-2">
                            {{ \App\Http\Controllers\HelperController::get_OriginName($product->origin) }}</div>
                        <div class="col-sm-12 col-md-3 py-2"><label for="" class="fw-bold">Year</label></div>
                        <div class="col-sm-12 col-md-9 py-2">
                            {{ $product->manufacure_year }}</div>
                        <div class="col-sm-12 col-md-3 py-2"><label for="" class="fw-bold">Size</label></div>
                        <div class="col-sm-12 col-md-9 py-2">
                            {{ \App\Http\Controllers\HelperController::get_RimSize($product->rim_size) }}</div>
                        <div class="col-sm-12 col-md-3 py-2"><label for="" class="fw-bold">Volve</label></div>
                        <div class="col-sm-12 col-md-9 py-2">
                            {{ \App\Http\Controllers\HelperController::get_TubeVolve($product->volve) }}</div>
                        ...
                        <div class="card-body text-center">
                            <div class="sc_services_item_content">
                                <h4 class="item_title"><a
                                        href="{{ route('frontend.tyre.product-detail', base64_encode($row->id)) }}">{{ $row->name }}<br>{{ \App\Http\Controllers\HelperController::get_RimSize($row->rim_size) }}</a>
                                </h4>
