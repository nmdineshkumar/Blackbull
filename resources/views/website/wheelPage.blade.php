                        ...
                        <div class="sc_section_inner">
                            <div class="woof_container_inner woof_container_inner_makemodelyearsize">
                                <div class="filter-select select2-selection">
                                    <select data-filter="true" data-target="model" data-url="{{ route('get-car-model', ':id') }}" id="make" class="selectpicker" data-live-search="true"
                                        data-container="body">
...
@section('add-js')
    <script>
        ...
        function getCarModel(data,id) {
            ...
            selectElement.setAttribute('data-target','year');
            selectElement.setAttribute('data-url','');
